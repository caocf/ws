...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function setName(goodTitle){
			$("#good_title").text("");
			
			$("#good_title").text(goodTitle);
  ...
  <body>
					...
					<form class="form-horizontal" action="" name="queryForm"
            			...
            			<div class="tab-pane fade in active" id="home">
                  		...
                  		<div class="controls controls-row">
                  			...
                  			<div>
								<input type="text" id="good_title" name="good_title" value="${good_title}"/>
		...
		<div>
			<iframe src="<%=path %>/analysis/commodity/showResults?good_title=${good_title}" id="busiFrame" name="busiFrame" marginwidth="0"
