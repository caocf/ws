...
<%--			else if(type==0){--%>
<%--			//	var good_title = $("#td_"+id).val();--%>
<%--				var good_title = document.getElementById("t_"+id).value;--%>
<%--				alert(good_title);--%>
<%--				//window.parent.test(id,type,good_title,${page});--%>
<%--				window.parent.document.getElementById("shop_name").value = good_title;--%>
<%--				window.parent.document.getElementById('busiFrame').src = "${ctx}/analysis/commodity/getItemList?id="+id+"&type="+type+"&good_title="+good_title+"&page=${page}";--%>
...
<%--			}--%>
		...
		function doOperator(id,name){
			...
			window.parent.document.getElementById('busiFrame').src = "${ctx}/analysis/commercial/getItemList?id="+id+"&type="+type+"&shop_name="+name+"&page=${page}";
		}
