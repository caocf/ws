...
<script type="text/javascript">
	$(function() {
		...
		$('button[name=btnExcel]').click(function() {
			var frm = document.getElementById("queryForm");
			frm.action = "${ctx}/businessOverview/merchant/detail/toExcel";
			frm.submit();
		});
...
<div class="row-fluid">
	<div class="span12">
			...
			<form id="queryForm" name="queryForm" class="form-horizontal" method="post">
				<div class="control-group group-search" style="margin-left: 0px;">
					...
					<div class="controls controls-row">
						<input id="shopIdStr" name="shopIdStr" type="hidden" value="${shopIdStr}" /> <input id="shopNameStr" name="shopNameStr" type="text" value="${shopNameStr}" placeholder="商户名称" title="商户名称" />
		...
		<div>
			<div style="text-align: left;">商户名称：${shopNameStr}</div>
