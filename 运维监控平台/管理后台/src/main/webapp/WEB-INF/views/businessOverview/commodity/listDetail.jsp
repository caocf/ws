...
<script type="text/javascript">
	$(function() {
		...
		$('button[name=btnExcel]').click(function() {
			var frm = document.getElementById("queryForm");
			frm.action = "${ctx}/businessOverview/commodity/detail/toExcel";
			frm.submit();
		});
...
<div class="row-fluid">
	<div class="span12">
			...
			<form id="queryForm" name="queryForm" class="form-horizontal" method="post">
				<div class="control-group group-search" style="margin-left: 0px;">
					...
					<div class="controls controls-row">
						<input id="itemIdStr" name="itemIdStr" type="hidden" value="${itemIdStr}" /> <input id="itemNameStr" name="itemNameStr" type="text" value="${itemNameStr}" placeholder="商品名称" title="商品名称" />
		...
		<div>
			<div style="text-align: left;">商品名称：${itemNameStr}</div>
