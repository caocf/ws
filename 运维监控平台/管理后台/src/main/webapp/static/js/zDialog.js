 ...
 * 最后修正：2010-3-18
 **/
var IMAGESPATH = '/data-center/static/images/dialog/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table class="dialog_table" id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="background:#ffffff;-moz-user-select: -moz-none; font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + ';border-bottom:1px #dedede solid">\
      ...
      <td height="33" style=""><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#000;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" style="background:#FF9900;color:#ffffff;margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px;' + (isIE6 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '">X</div></td>\
...
'
    ...
    if (!div) {
        ...
        div.style.border= "3px solid rgb(255,153,0)";
