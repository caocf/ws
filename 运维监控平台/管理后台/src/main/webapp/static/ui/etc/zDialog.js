...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table class="dialog_table" id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="background:#ffffff;-moz-user-select: -moz-none; font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + ';border-bottom:1px #dedede solid">\
      <td width="0" height="33" style=""></td>\
      <td height="33" style=""><div class="modal-header"><button onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h4 class="myModalLabel" id="_Title_' + this.ID + '">' + this.Title + '</h4></div>\
        </td>\
      <td width="0" height="33" style=""></td>\
    </tr>\
    <tr valign="top" >\
      ...
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="35"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="" id="_MessageTable_' + this.ID + '">\
                <tr>\
	...
	' + (function (obj) {
        ...
        if (obj.URL) return '<div id="_DialogFrameLoading_'+ this.ID+'" class="preloader-pos"><img src="../../static/ui/images/preloaders/blue/4.gif"/></div><iframe width="100%" height="100%" frameborder="0" style="display:none;border:none 0;" allowtransparency="true" id="_DialogFrame_' + obj.ID + '" src="' + obj.displacePath() + '"></iframe>';
        return "";
    })(this) + '\
              </div></td>\
          </tr>\
    ...
    <tr>\
      <td width="0" height="13" style=""></td>\
      <td style=""></td>\
      <td width="0" height="13" style=""><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
    ...
    if (!div) {
        ...
        //div.style.borderColor="rgb(255,153,0)";
