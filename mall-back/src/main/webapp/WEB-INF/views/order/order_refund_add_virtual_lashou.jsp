...
<html>
	<head>
	    ...
	    function sub(){
	 		var selectNum=$("input[name='actOrderGoodsCheck']:checked");
	 		var totalNum=$("#totalCode").val();
	 		if(selectNum.length <totalNum){
	 			alert("请勾选全部验证码");
	 			return false;
	 		}else{
	 			return true;
	...
	<body>
		<div id="content">
			<div class="box">
			    ...
			    <form:form method="post" id="fm"  onsubmit="return sub();" commandName="orderRefund" htmlEscape="true" acceptCharset="utf-8" cssClass="required-validate">
			        <div class="form">
			            ...
			            <input type="hidden" id="backNumber" name="backNumber" value="${codeNum }"/>
			            <input type="hidden" id="totalCode" name="totalCode" value="${codeNum }"/>
			            ...
			            <div class="fields">
			                ...
			                <div class="field">
								...
								<div class="select">
									...
									<table class="datalist fixwidth">
							            ...
							            <tr>
							            	<td nowrap="nowrap">
							            		<c:if test="${code.codeStatus ==0}">
							            		<input type="checkbox" checked name="actOrderGoodsCheck" value="${code.orderId}"  />
							            		</c:if>
							            		<c:if test="${code.codeStatus !=0}">
							            		<input type="checkbox" disabled name="actOrderGoodsCheck" value="${code.orderId}"  />
							            		</c:if>
			                ...
			                <div class="field">
			                    ...
			                    <div class="input"><span id="codeCount" style="color: red;">${codeNum }</span></div>
			                </div>
			                <div class="field">
			                    <div class="label">
