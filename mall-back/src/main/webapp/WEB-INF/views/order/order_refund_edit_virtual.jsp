			        ...
			        <div class="form">
			            ...
			            <div class="fields">
			                ...
			                <div class="field">
			                    ...
			                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			                    <label>现金：</label>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                <input value="${orderRefund.cashFee/100 }" id="cash" onblur="getThisRefundAmount('${maxCash }', '${maxCoin }')"  class="validate-number required" name="cashFee" type="text" style="width:100px;height:20px;"/>&nbsp; &nbsp; &nbsp;&nbsp;
			                    ...
			                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			                    <label>商城币：</label>&nbsp; &nbsp;&nbsp;
				                <input  value="${orderRefund.coinFee/100 }" id="coin" onblur="getThisRefundAmount('${maxCash }', '${maxCoin }')"  class="validate-number required" name="coinFee" type="text" style="width:100px;height:20px;"/>&nbsp; &nbsp; &nbsp;&nbsp;
			                    ...
			                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			                    <label>积分：</label>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                <input value="${orderRefund.scoreFee/100 }"   readonly class="validate-number required" name="scoreFee" type="text" style="width:100px;height:20px;"/>&nbsp; &nbsp; &nbsp;&nbsp;
			                    ...
			                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			                    <label>话费：</label>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                <input value="${orderRefund.phoneFee/100 }"   readonly class="validate-number required" name="phoneFee" type="text" style="width:100px;height:20px;"/>&nbsp; &nbsp; &nbsp;&nbsp;
