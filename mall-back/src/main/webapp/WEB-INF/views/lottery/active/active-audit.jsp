        ...
        <div class="form">
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <div class="radios">
                        <div class="radio">
                            <input class="validate-one-required" type="radio" id="radio-1" name="status" <c:if test="${active.status==2 }"> checked="checked" </c:if> value="2"/><label for="radio-1">通过</label>
                            <input class="validate-one-required" type="radio" id="radio-2" name="status" <c:if test="${active.status==3 }"> checked="checked" </c:if> value="3"/><label for="radio-2">驳回</label>
                        </div>
