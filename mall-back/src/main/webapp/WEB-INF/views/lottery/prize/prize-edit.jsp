...
<div class="box">
    ...
    <div class="title">
        <h5>添加奖品</h5>
		  ...
		  <form:form action="${ctx}/lottery/prize/edit/${prize.id}" method="post" id="fm" commandName="prize" htmlEscape="true" acceptCharset="utf-8" cssClass="required-validate">
        ...
        <div class="form">
                    ...
                    <div class="input">自动生成</div>
 					...
 					<div class="field" >
							...
							<div class="input">
								<form:input path="name" cssClass=" required " maxlength="100" style="width:500px"/>
				...
				<div class="field" >
							...
							<div class="input">
								...
								<input id="active"  class=" required " maxlength="50" style="width:500px" value="${activeName }"/>
					...
					<span style="color:red;" id="prizeNumValueHide">温馨提示：该活动拥有的奖区数量为${ prizeNumValue}个</span>
					<input type="hidden" id="prizeNum" value="${ prizeNumValue}"/>
						<div class="field" >
							<div class="label">
								<label for="hitLevel" class="req">奖区编号:</label>
							</div>
							<div class="input">
								<form:input path="hitLevel" class=" less-than-equal-prizeNum required required validate-number" maxlength="2" style="width:100px"/>
						...
						<div class="field" >
							...
							<div class="input">
								<form:input path="hitProbability" class=" required validate-number" maxlength="5" style="width:100px"/>
						...
						<div class="field" >
							...
							<div class="input">
								<form:input path="hitLimit" class=" required validate-number" maxlength="2" style="width:100px"/>
						...
						<div class="field" >
							...
							<div class="input">
								<form:input path="hitMsg" class=" required " maxlength="50" style="width:500px"/>
						...
						<div class="field" >
							...
							<div class="input">
								<form:input path="numbers" class=" required validate-number" maxlength="6" style="width:100px"/>
					...
					<div class="field" >
							...
							<div class="input">
								<form:input id="position" path="position" class=" required " maxlength="20" style="width:100px"/>
							...
							<div class="input">
								<textarea id="description" name="description" class="max-length-100"
									rows="8" cols="50">${prize.description }</textarea>
							</div>
						</div>		
