...
//入库
function chackUndercarriageStatus(){
	if($("input[name='serialNo']:checked").length == 0 ){
	 ...
	 dealInfo("确认入库","./cardStockIn?serialNo="+str);
}
</script>
</head>
<body>
			...
			<c:if test="${not empty pageData}">
				...
				<table class="datalist fixwidth">
					 <tr>
			        	...
			        	<ct:display model="stock_model" btn="st_i_btn">
			        		<ht:table-action-btn text="入库" url=""  onAction="chackUndercarriageStatus"/>
			        	</ct:display>
			        	</td>
        			</tr>
					<tr>
