        ...
        <div class="form">
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <div class="select">
                        <form:select path="pubDest" onchange="change();" disabled="true">
                  ...
                  <div class="field">
                    ...
                    <div class="input">
	                     <input type="text" id="endTime" name="endTime" 
										...
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'2020-10-01'})" value="<ct:time source="${sysAnnouncement.endTime }" sfmt="yyyyMMddHHmmss" tfmt="yyyy-MM-dd HH:mm:ss"/>" />
                    </div>
                </div>

			<div id="storeDiv"   <c:if test="${sysAnnouncement.pubDest == 3}"> style="display:none"</c:if>  >
                <div class="field">
                    <div class="label">
          ...
          <div id="indexDiv" <c:if test="${sysAnnouncement.pubDest == 1}"> style="display:none"</c:if>>
          	  ...
          	  <div class="field">
                    ...
                    <div class="input">
                        <select id="adviseType" name="title" onchange="changeType();">
                        	<option value="0" <c:if test="${sysAnnouncement.title == 0 }">selected="selected"</c:if>>静态公告</option>
                        	<option value="1" <c:if test="${sysAnnouncement.title == 1 }">selected="selected"</c:if>>拉伸公告</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="field">
                    <div class="label">
                        <label for="description" >公告图片：</label>
                    </div>
                    <div class="input">
                       	<input type="file" id="uploadfileAdvise" name="uploadfileAdvise" size="40" class=" validate-file-jpg-png-gif"  />
                       	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 ...
                 <div class="field" id="extendAdvise" <c:if test="${sysAnnouncement.title == 0 }">style="display:none"</c:if>>
	                 <div class="input">
	                       	<input type="file" id="uploadfileAdviseExtend" name="uploadfileAdviseExtend" size="40" class=" validate-file-jpg-png-gif"  />
	                       	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                        ...
	                        <span class="error" id="advice-validate-uploadfileAdviseExtend" style="display:none"></span>
	                    </div>
                 </div>
