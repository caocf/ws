...
<body>
	...
	<div id="search-menu">
		<ul>
			...
			<ct:display model="item_list" btn="add_btn">
				...
				<table class="datalist fixwidth">
					<colgroup>
					 ...
					 <tr>
			        	...
			        	<ct:display model="item_list" btn="down_line_btn">
			        	...
			        	<ct:display model="item_list" btn="del_btn">
			        		<ht:table-action-btn text="删除" url="/item/item/delete"  onAction="checkDel"/>
			        	</ct:display>
			        	</td>
        			</tr>
					<tr>
						...
						<tr>
							...
							<td nowrap="nowrap">
							 <c:if test="${item.status==3}">
							    <ct:display model="item_list" btn="preview_btn">
							 ...
							 <c:if test="${item.status!=-1}">	
							    ...
							    <c:if test="${item.status==0}">
									<ct:display model="item_list" btn="send_btn">
								...
								-->
								<ct:display model="item_list" btn="img_btn">
