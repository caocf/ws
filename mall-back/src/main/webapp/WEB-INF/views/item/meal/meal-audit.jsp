						...
						<div id="para" >
						 ...
						 <div class="field">
			                    ...
			                    <div class="checkboxes" id="payType1"  <c:if test="${!payTypeFg }">style="display: none;"</c:if>/>
			                        <div class="checkbox">
			                            <input type="checkbox" id="checkbox-1" name="cashIdgoods"  value="1" onclick="change1()" <c:if test="${itemSale.cashIdgoods == 1 }">checked="checked"</c:if>/><label for="checkbox-1">现金</label>
			                            <input type="checkbox" id="checkbox-2" name="coinIdgoods" value="1" onclick="change2()" <c:if test="${itemSale.coinIdgoods == 1 }">checked="checked"</c:if>/><label for="checkbox-2">商城币</label>
			                        	<input type="checkbox" id="checkbox-3" name="scoreIdgoods"  value="1" onclick="change3()" <c:if test="${itemSale.scoreIdgoods == 1 }">checked="checked"</c:if>/><label for="checkbox-3">积分</label>
			                        </div>
			                    </div>
						...
						<div class="field" id="numLimit"
							...
							<div class="input">
								<input id="userPerBuyNum" name="userPerBuyNum"
									class="  validate-pattern-/^[0-9]*[1-9][0-9]*$/" type="text"
