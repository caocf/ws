        ...
        <div class="form">
            <div class="fields">
				...
				<div class="field">
                    ...
                    <div class="radios">
                        <div class="radio">
                            <input type="radio" id="radio-1" name="isShow" checked="checked" value="1" class="validate-one-required"/><label for="radio-1">是</label>
                            <input type="radio" id="radio-2" name="isShow" value="0" /><label for="radio-2">否</label>
