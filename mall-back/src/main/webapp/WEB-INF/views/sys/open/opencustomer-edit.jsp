...
<div class="box">
	...
	<input type="hidden" id="openCustomerAppKey" name="appKey" value="${openCustomer.appKey }" />
        <div class="form">
            <div class="fields">
                <div class="field">
                ...
                <div class="field">
                 ...
                 <div class="field">
                    ...
                    <div class="input">
                    <form:textarea path="remark" cssClass="small required" maxlength="1000" ></form:textarea>
                    </div>
                </div>
                 ...
                 <div class="field">
                    ...
                    <div class="input">
                    <form:textarea path="ips"  maxlength="300" ></form:textarea>
				...
				<div class="field">
                    ...
                    <div class="input">
                        <form:input path="payNotify" cssClass="small" maxlength="200"/>
                ...
                <div class="field">
                    ...
                    <div class="input">
                    	...
                    	<c:forEach items="${appTypeMap }" var="item">
                        	    <option value="${item.key }" <c:if test="${item.key == openCustomer.appType}">selected="selected"</c:if>>${item.value }</option>
                        </c:forEach>
                    </select>
                    </div>
                </div>
                <div class="field" id="shopClassDiv" <c:if test="${1 == openCustomer.appType}">style="display:none"</c:if>>
                    <div class="label">
                    ...
                    <div class="input">
                    	...
                    	<c:forEach items="${shopClassMap }" var="item">
                        	    <option value="${item.key }" <c:if test="${item.key == openCustomer.shopClass}">selected="selected"</c:if>>${item.value }</option>
                        </c:forEach>
                    </select>
                    </div>
                </div>
                <div class="field" id="shopDiv" <c:if test="${1!=openCustomer.shopClass}">style="display:none"</c:if>>
                    <div class="label">
                ...
                <div class="field" id="storeDiv" <c:if test="${empty openCustomer.shopClass || 1==openCustomer.shopClass}">style="display:none"</c:if>>
                    <div class="label">
                ...
                <div class="field">
                    ...
                    <div class="checkboxes">
                        <div class="checkbox1">
                         ...
                         <input type="checkbox" id="role${item.id}" name="role" value="${item.id }" />
