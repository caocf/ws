...
public class TimeUtil {
	...
	public static String format(Object source, String sfmt, String tfmt,
		...
		try {
			...
			if (logger.isDebugEnabled()) {
				logger.debug("Source Parse Exception: source=" + source
						+ ", sfmt=" + sfmt + ", tfmt=" + tfmt, e);
			}
		} catch (IllegalArgumentException e) {
			if (logger.isDebugEnabled()) {
				logger.debug("Illegal Source Exception: source=" + source
						+ ", sfmt=" + sfmt + ", tfmt=" + tfmt, e);
			}
		} catch (Exception e) {
			if (logger.isDebugEnabled()) {
				logger.debug("Exception: source=" + source + ", sfmt=" + sfmt
						+ ", tfmt=" + tfmt, e);
			}
		}
		return EMPTY;
	...
	public static void main(String[] args) {
		...
		// 30), "20121212090000"));
		System.out.println(TimeUtil.now("yyyyMM"));
	}
