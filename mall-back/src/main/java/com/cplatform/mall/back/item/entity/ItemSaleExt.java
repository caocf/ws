...
public class ItemSaleExt {
	...
	/**
	 * @Column(name = "LOGISTICS_FEE", precision = 9, scale = 2) public Double
	 *              getLogisticsFee() { return logisticsFee; } public void
	 *              setLogisticsFee(Double logisticsFee) { this.logisticsFee =
	 *              logisticsFee; }
	 * @Column(name = "LOGISTICS_FEE_TYPE", precision = 1, scale = 0) public
	 *              Long getLogisticsFeeType() { return logisticsFeeType; }
