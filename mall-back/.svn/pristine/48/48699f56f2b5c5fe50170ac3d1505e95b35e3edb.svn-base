...
<div id="search-menu">
    <ul>
        <ht:menu-btn text="商品基本信息" url="/item/item/preEdit/${sale.id}" />
        <ht:menu-btn text="商品属性参数" />
        <ht:menu-btn text="商品图片" url="/item/item/img/upd/${sale.id}"/>
    </ul>
    <br style="clear: left" />
</div>
        ...
        <div class="fields">
        	...
        	<div class="field">
        	 ...
        	 <div class="field">
        	 	...
        	 	<div class="input">
                     <input name="itemParam_${item.id}" maxlength="100" <c:if test="${item.requiredFlag==1}">class="small required"</c:if>/>
            ...
            <div class="field">
                    ...
                    <div class="dd">
                      <input type="hidden"  name="flag" id="flag" value="0"/>
                        <input type="text"  name="itemProperyName" maxlength="100" class="small required"/>
                        <input type="file"  name="uploadPropertyPic" re size="40" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="javascript:void(0);" id="del" onclick='delDiv(this);' title="删除"><font color="red">删除</font></a>
                        <span class="error" id="advice-required-itemProperyName" style="display:none"></span>
