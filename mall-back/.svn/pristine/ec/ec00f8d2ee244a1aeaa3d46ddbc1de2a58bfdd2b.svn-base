...
<div class="box">
    ...
    <form:form method="post" id="fm" commandName="task" htmlEscape="true" acceptCharset="utf-8" cssClass="required-validate" enctype="multipart/form-data">
        ...
        <input type="hidden" name="smil" value="${task.smil }"/>
              ...
              <div class="field">
                ...
                <div class="field">
                 ...
                 <div class="field">
                    ...
                    <div class="input">
                         <iframe name="user_frame" width="100%" height="280" scrolling="auto" marginheight="0" marginwidth="0" frameborder="0" src="${ctx}/batch/mmsInfoList" align="top"></iframe>
                    </div>
                </div>
              <div class="field">
                  <div class="label">
