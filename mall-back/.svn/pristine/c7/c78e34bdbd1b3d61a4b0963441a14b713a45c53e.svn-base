            ...
            <div class="fields">
                <div class="field">
                  <div class="label">
                    ...
                    <div class="input">
                    ${smsbuyItemRouter.actName }(${smsbuyItemRouter.actId })
                    <form:hidden path="taskName" value="${smsbuyItemRouter.actName }(${smsbuyItemRouter.actId })"/>
                    <form:hidden path="actId" value="${smsbuyItemRouter.actId }"/>
                    <form:hidden path="routerId" value="${smsbuyItemRouter.id }"/>
                    <input type="hidden" id="backUrl" name="backUrl" />
                    </div>
              </div>
              <div class="field">
                  <div class="label">
                        <label for="itemid" class="req">商品ID：</label>
                    </div>
                    <div class="input">
                    ${smsbuyItemRouter.itemId }
                    <form:hidden path="itemId" value="${smsbuyItemRouter.itemId }"/>
                    </div>
              </div>
              <div class="field">
                    <div class="label">
                  ...
                  <div class="label">
                    ...
                    <div class="input">
                    	${smsbuyItemRouter.spCode }
                    	 <form:hidden path="spCode" value="${smsbuyItemRouter.spCode }"/>
                    </div>
              </div>
                <div class="field">
