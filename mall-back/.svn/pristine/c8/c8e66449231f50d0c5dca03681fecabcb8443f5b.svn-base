...
<div class="box">
    ...
    <!-- end box / title -->
    <form id="fm" class="required-validate" action="${ctx }/store/store/storeAudit" method="post" accept-charset="utf-8">
        ...
        <div class="form">
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <div class="radios">
                        <div class="radio">
                            <input type="radio" id="radio-1" name="status" checked="checked"  value="${status }"/><label for="radio-1">通过</label>
