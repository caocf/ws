        ...
        <table class="datalist fixwidth">
            ...
            <tr>
                ...
                <td width="100" nowrap="nowrap">
                   ...
                   <ct:display model="vitual_audit_list" btn="view_btn">
                        <a href="view/${item.id}">查看</a>&nbsp;&nbsp; 
                    </ct:display>
                     <ct:display model="vitual_audit_list" btn="preview_btn">
						<a href="#this" id="${item.id}" class="view">预览</a>&nbsp; &nbsp;
					</ct:display>
                      <c:if test="${item.status==1}">
                       <ct:display model="vitual_audit_list" btn="audit_btn">
                        <a href="${ctx}/item/vitual/auditing/${item.id}">审核</a>
	                	&nbsp;&nbsp;
	                </ct:display>
                     </c:if>
                </td>
