...
<!-- 								<label for="sort" class="req">活动类型:</label> -->
<!-- 							</div> -->
<!-- 							<div class="radios"> -->
<!-- 								<div class="radio"> -->
<!-- 									<input type="radio" id="sort1" name="activeType" value="0" checked /><label for="sort1">不设置参与条件</label> -->
<!-- 									<input type="radio" id="sort0" name="activeType" value="1"  /><label for="sort0">设置参与条件</label> -->
<!-- 								</div> -->
...
<!-- 						</div>	 -->
						...
						<div class="field">
							...
							<div class="radios">
								<div class="radio">
									<input class="validate-one-required" checked type="radio" id="sort1" name="prizeNum" value="8"/><label for="sort1">8个</label>
									<input class="validate-one-required" type="radio" id="sort1" name="prizeNum" value="12"/><label for="sort1">12个</label>
								</div>
						...
						<div class="field">
							...
							<div class="radios">
								<div class="radio">
									<input type="radio" id="sort1" name="unhit" value="0" checked /><label for="sort1">未中奖无奖品</label>
									<input type="radio" id="sort0" name="unhit" value="1"  /><label for="sort0">参与抽奖既赠奖品</label>
								</div>
								<span class="error" id="advice-validate-one-required-radioex1" style="display:none"></span>
							</div>
						</div>	
