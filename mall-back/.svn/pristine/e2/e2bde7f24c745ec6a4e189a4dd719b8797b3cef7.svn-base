	 ...
	 <div class="fields">
	 		<div class="field">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        <form:input type="text" path="startTime"  cssClass="required"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="true"/>
                    </div>
                </div>
		         <div class="field">
                    <div class="label">
                    ...
                    <div class="input">
                         <form:input type="text" path="endTime"  cssClass="required" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="true"/>
                    </div>
                </div>
                		
                <div class="field">
                <div class="label">
                 <label for="contentSrc" class="req">选择区域：</label>
                 </div>
                <div class="input">
