CREATE TABLE "LIFE".t_member_orgi (
...
ALTER TABLE "LIFE".t_member_orgi ADD SUPPLEMENTAL LOG GROUP ggs_244630 (area_code, birthday, cart_uuid, email, "ID", nick_name, opened, qq, real_name, red_member, reg_source, reg_time, remark, sex, signature, status, terminal_id, update_time, user_level, user_name, user_pass, vid) ALWAYS;