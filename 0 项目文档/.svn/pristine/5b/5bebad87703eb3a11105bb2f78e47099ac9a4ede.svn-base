CREATE procedure "LIFE".P_STORE_GETCODE_BYTYPE(v_store_id in t_verify_store_code_common.store_id%type,
                                            v_type_id  in t_verify_store_code_common.code_name_id%type,
