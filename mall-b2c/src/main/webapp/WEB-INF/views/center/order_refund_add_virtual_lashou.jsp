...
<body id="usercenter">
	...
	<div class="wrapper mauto">
	  ...
	  <form:form method="post" action="/center/applyRefund.chtml" id="fm"  commandName="orderRefund" htmlEscape="true" acceptCharset="utf-8" cssClass="center_applyRefund">
         ...
         <input type="hidden" id="refundStrategy" name="refundStrategy" value="${refundStrategy }"/>
						...
						<dl>
							...
							<dd>
								...
								<c:if test="${mapPayMent.maxCoin > 0}">
									商城币：<input type="text" value="${mapPayMent.maxCoin }" class="disinput" readonly="readonly" /> 元 <br />
								</c:if>
