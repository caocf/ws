        ...
        <div class="detail">
            <div class="detail">
				...
				<div class="itemlist_info">
					...
					<dl>	
                    	<dt>商品：</dt>
                    	<dd><c:forEach items="${info.goodsInfos}" var="data">
                    	<c:if test="${info.orderType eq 1000 }">
                    	<a>${data.goodsSubject } * ${data.count }</a><br />
                    	</c:if>
                    	<c:if test="${info.orderType ne 1000 }">
                    		<a href="<ct:path flag='1' id='${data.goodsId }'/>" class="col_link" >${data.goodsSubject } * ${data.count }</a><br />
                    	</c:if>	
                    	</c:forEach>
                    	</dd>
					</dl>
