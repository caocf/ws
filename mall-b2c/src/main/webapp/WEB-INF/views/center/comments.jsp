...
<form action="comments.chtml" method="post" id="form1">
                        ...
                        <c:forEach items="${list}" var="data">
                            <div class="item">
                                <div class="user">
                                    ...
                                    <span class="u-level"><c:if test="${data.status eq 0}"><img src="../img/icon_yel.jpg" /></c:if><c:if test="${data.status eq 2}"><img src="../img/icon_red.jpg" /></c:if></span> </div>
                                <div class="i-item" data-guid="9ac660f0-744d-48fc-8709-cea0e0419450">
                                    <div class="o-topic"><span class="star sa${data.rank }"></span><span><em class="fr"></em></span><span class="date-comment">${data.commentTime }</span> </div>
