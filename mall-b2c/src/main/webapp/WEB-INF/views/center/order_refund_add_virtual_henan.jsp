			...
			<div class="content">
				<div class="tk_goods_info">
					...
					<dl>
						<dt>订单价格：</dt>
						<dd>
							<span class="f14 red"><fmt:formatNumber value="${mapPayMent.orderSum*100 }" pattern="0"/></span>个
						</dd>
					</dl>
					<dl>
						<dt>已退金额：</dt>
						<dd>
							<fmt:formatNumber value="${mapPayMent.refunded_yuan*100 }" pattern="0"/><span>个</span>
						</dd>
					</dl>
					<dl>
						<dt>商品名称：</dt>
						...
						<dl>
							...
							<dd>
								<c:if test="${mapPayMent.maxCash > 0}">
									现&nbsp;&nbsp;&nbsp;金：<input type="text" value='<fmt:formatNumber value="${mapPayMent.maxCash }" pattern="0"/>' name="cashFee" class="disinput" readonly="readonly" /> 元 <br />
								</c:if>
								<c:if test="${mapPayMent.maxCoin > 0}">
									商城币：<input type="text" value='<fmt:formatNumber value="${mapPayMent.maxCoin }" pattern="0"/>' class="disinput" readonly="readonly" /> 元 <br />
								</c:if>
								<c:if test="${mapPayMent.maxScore > 0}">
									积&nbsp;&nbsp;&nbsp;分：<input type="text" value='<fmt:formatNumber value="${mapPayMent.maxScore }" pattern="0"/>' name="scoreFee" class="disinput" readonly="readonly" />元 <br />
								</c:if>
								<c:if test="${mapPayMent.maxBalance > 0}">
									话&nbsp;&nbsp;&nbsp;费：<input type="text" value='<fmt:formatNumber value="${mapPayMent.maxBalance }" pattern="0"/>' name="phoneFee" class="disinput" readonly="readonly" />元 <br />
								</c:if>
