...
<head>
    ...
    <meta name='WT.shopping_n' content='ddqry'/>
    <meta name='WT.shopping_x' content='50'/>
    ...
    <script type="text/javascript" src="../js/confirm-order-common.js?v=1.01"></script>
...
<div class="neworderBox address-block">
    <div class="shouhuoInfo2">
        <h2 class="title">收货人地址 <a class="f12 col_link fn" id="address_show" href="javascript:void(0);" style="display: none;">修改</a></h2>
...
<div class="neworderBox invoice-block">
    <div class="shouhuoInfo2">
        <h2 class="title">发票信息 <a class="f12 col_link fn" id="invoice-show" href="javascript:void(0);" style="display:none;"> 修改 </a></h2>
        ...
        <div class="editproduct">
            <table cellspacing="0" cellpadding="0" border="0" width="964">
                ...
                <tr>
                    ...
                    <th>商品</th>
                    <th class="tr" width="10%">单价（元）</th>
                    <th width="10%">数量</th>
                    <th width="10%">优惠活动</th>
                    <th class="tr" width="15%">小计（元）</th>
                </tr>
                <tr class="bt1px">
                    <td class="tc"></td>
                    <td class="tl" colspan="6" id="shopName">商户：<a class="shop_tag" target="_blank"></a></td>
                </tr>
                <tr class="order_item discount_block" id="discount_block">
                ...
                <tr class="order_item">
                    <td colspan="2" class="tl" id="shop_leave_message">
                        <span class="pl20">给商家留言：</span> <input id="leave_message" type="text" maxlength="100" /></td>
                    <td colspan="2" class="tr"><span style="font-weight: bolder" id="shop_total">店铺总计：</span></td>
    ...
    <div class="order_submit">
        <div id="order_submit_price">
            <table width="100%" cellspacing="0" height="30" cellpadding="0" border="0">
                <tbody>
                <tr>
                    <td width="700" class="table_left" style="display:none;"><span class="order_b_alert">提示：</span>请务必在<span class="order_c_alert">15分钟内</span>完成支付，否则订单将自动取消。</td>
    ...
    <table id="tmpl_item">
        <tr class="order_item item_iter">
            <td class="tc">
                ...
                <input type="hidden" name="iseckill"/>
                <input type="hidden" name="checpPrice" />
            </td>
            <td class="tl">
                <ul></ul>
            </td>
            ...
            <td>
                <div class="price">
                	<span class="cart_cheap_price" style="display: none"></span>
                	<a class="cart_cheap_info" href="javascrpt:void(0)" style="display: none"></a>
                	<div class="cart_cheap_info_panel" style="display: none;">
                    	<div class="cart_cheap_info_tit"></div>
                    	<div class="car_cheap_info_cont"></div>
                    </div>
                </div>
                 <script type="text/javascript">
                	$(function(){
						$(".cart_cheap_info").mouseover(function(e) {
                            $(".cart_cheap_info_panel").css("display","block");
                        });
						$(".cart_cheap_info").mouseout(function(e) {
                            $(".cart_cheap_info_panel").css("display","none");
                        });
					})
                </script>
            </td>
