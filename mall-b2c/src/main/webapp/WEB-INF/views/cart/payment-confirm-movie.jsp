...
<head>
    ...
    <link href="http://www.12580life.com/tmovie/css/movie.css" rel="stylesheet" type="text/css" />
	<link href="../css/moviecart.css" rel="stylesheet" type="text/css" />
    ...
    <style>
        ...
        #timeb1.col_link{ background:#B2354E; color:#fff; padding:3px 10px;}
    </style>
</head>
<body id="movie">
<jsp:include page="m_head.jsp">
			<jsp:param value="cinema" name="naviCode"/>
		</jsp:include>
<div class="wrapper mauto">
	      <div class="movie_title">
	        <ul class="pay_movie_title">
	            ...
	            <li >2.确认订单</li>
	            <li id="hover" class="last"><a href="#">3.完成支付收取电子码</a></li>
	        </ul>
	      </div>
        <!-- 新的order page -->
...
<script>
    $(function () {
        ...
        if(toDecimal(allowCoin) >= toDecimal(payAmounts)){
            $('.use_coin,.pay_coin').text(toDecimal2(payAmounts));
            $('.enough_coin').show();
        ...
        if(toDecimal(toDecimal(allowScore)*0.015) >= toDecimal(payAmounts)){
            $('.use_score').text(toDecimal3(toDecimal(payAmounts)/0.015));
            $('.pay_score').text(toDecimal2(payAmounts));
            $('.enough_score').show();
        ...
        if(toDecimal(balance) >= toDecimal(payAmounts)){
            $('.use_bill,.pay_bill').text(toDecimal2(payAmounts));
            $('.enough_bill').show();
