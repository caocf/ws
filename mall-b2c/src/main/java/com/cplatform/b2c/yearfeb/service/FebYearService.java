package com.cplatform.b2c.yearfeb.service;
...
@Service
public class FebYearService {

	@Autowired
	DbHelper dbHelper;

	public ListPage<Map<String, Object>> findFebYearActivity(int page, int pageSize, String areaCode) throws SQLException {
		...
		sql.append(" from T_FEB_YEAR_ACTIVITY tya left join T_FEB_YEAR_GOODS_REGION tygr on tya.SALE_ID = tygr.sale_id  where 1=1");
