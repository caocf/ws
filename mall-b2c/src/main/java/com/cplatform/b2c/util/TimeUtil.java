...
public class TimeUtil {
	...
	public static String convertStringFormat(String dateString) throws Exception {
		SimpleDateFormat sdf = new SimpleDateFormat(SOURCE_1);
		Date date = sdf.parse(dateString);
		return formartString(date);
	}

	public static String formatDateString(String dateString) throws Exception {
		SimpleDateFormat sdf = new SimpleDateFormat(SOURCE_1);
		Date date = sdf.parse(dateString);
